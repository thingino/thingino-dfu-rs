...
mod tests {
    ...
    fn a_phase_change_and_a_byte_count_both_reach_the_progress_callback() {
        ...
        assert_eq!(
            ...
            Some(("verifying".to_owned(), 4096, Some(16 * 1024 * 1024)))
        );
        ...
        assert_eq!(
            ...
            Some(("reading".to_owned(), 512, None))
        );
    }
    ...
    fn a_note_goes_to_the_log_and_never_to_the_progress_bar() {
        ...
        let note = Progress::Note("Write complete".to_owned());
        assert_eq!(note_of(&note), Some("Write complete"));
