...
//!
//! * **A successful local write printed nothing** — no `Write complete`, no
...
impl core::fmt::Display for Phase {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(match self {
            ...
            Self::Stage1 => "stage1",
            Self::UBoot => "u-boot",
            Self::Download => "writing",
            Self::Manifest => "finishing",
            Self::Upload => "reading",
...
mod tests {
    ...
    fn every_phase_has_its_own_word() {
        let named = [
            ...
            (Phase::Stage1, "stage1"),
            (Phase::UBoot, "u-boot"),
            (Phase::Download, "writing"),
            (Phase::Manifest, "finishing"),
