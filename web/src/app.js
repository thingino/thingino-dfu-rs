...
/* The engine names its phases in the DFU protocol's own terms (an "upload" moves
 * bytes from the device to the host, a "download" the other way). The page has
 * always spoken to its user in plain words, so the bar keeps the labels the
 * shipped flasher used. */
var PHASE_LABELS = {
    'upload': 'Reading flash via DFU...',
    'download': 'Writing flash via DFU...',
    'verify': 'Verifying flash via DFU...',
    'erase': 'Erasing flash via DFU...',
