...
I18N.add("en", {
  ...
  help_rel_branch: "Which branch's builds to pick from: master (its builds are marked prerelease on GitHub) or ciao, the branch the stable firmware releases are built from.",
  help_rel_release: "Which firmware release to flash: the chosen branch's releases from the thingino GitHub repository, newest first. master builds are tagged master-<date>; ciao's are the stable firmware-<date> releases.",
